...
public class ConfigGenerator {
    public void generateConfig(DbParameters dbP) {
        Common.writeToJavaFile(Package.AUTOGENERATED_CONFIG, TypeSpec.classBuilder("DbCon")
                .addModifiers(Modifier.PUBLIC)
                .addAnnotation(Slf4j.class)
                .addMethod(generateMethodConnection(dbP)).build());
    }

    private MethodSpec generateMethodConnection(DbParameters dbP) {
